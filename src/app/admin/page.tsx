...
export default async function AdminPage({
  ...
  return (
    <AppShell>
      ...
      <form className="mb-6 grid gap-4 rounded-3xl border border-[color:var(--border)] bg-white/85 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:grid-cols-[1fr_auto] sm:items-center">
        <input
          type="search"
          name="query"
          defaultValue={query}
